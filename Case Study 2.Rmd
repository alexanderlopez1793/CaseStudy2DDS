...
- Linear Regression model yields RMSE = 1372.05. Variables to considered were selected after reviewing data during EDA. Job Level seems to hold the most significance when predicting monthly income (p-value = <2e-16).
